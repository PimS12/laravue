...
return [
    ...
    | несколько версий, например, правила размера. Не стесняйтесь изменять
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете указать пользовательские сообщения об ошибках для атрибутов,
    | используя соглашение "attribute.rule" для именования строк. Это быстрое
    | указание конкретного пользовательского сообщения для данного правила атрибута.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие языковые строки используются для замены нашего заполнителя атрибутов
    | на что-то более читабельное, например, "Адрес электронной почты" вместо "email".
    | Это помогает сделать наше сообщение более выразительным.
    |
    */
